...
namespace btl.net.Forms
{
    public partial class chatlieu : Form
    {
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT Machatlieu FROM tblchatlieu WHERE Machatlieu=N'" + txtma.Text.Trim() + "'";
            ...
            sql = "INSERT INTO tblchatlieu(Machatlieu, Tenchatlieu) VALUES(N'" + txtma.Text.Trim() + "', N'" + txtten.Text.Trim() + "')";
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblchatlieu SET Tenchatlieu=N'" + txtten.Text.Trim() + "' WHERE Machatlieu=N'" + txtma.Text + "'";
            Class.Functions.RunSql(sql);
            Load_DataGridView();
            ResetValues();
            btnboqua.Enabled = false;
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE FROM tblchatlieu WHERE Machatlieu=N'" + txtma.Text + "'";
        ...
        private void btntimkiem_Click(object sender, EventArgs e)
        {
            ...
            if (txtma.Text != "")
                sql += " AND Machatlieu LIKE N'%" + txtma.Text + "%'";
            if (txtten.Text != "")
                sql += " AND Tenchatlieu LIKE N'%" + txtten.Text + "%'";
            tblchatlieu = Class.Functions.GetDataToTable(sql);
            if (tblchatlieu.Rows.Count == 0)
        ...
        private void DataGridView_Click_1(object sender, EventArgs e)
        {
            ...
            txtma.Text = DataGridView.CurrentRow.Cells["Machatlieu"].Value.ToString();
            txtten.Text = DataGridView.CurrentRow.Cells["Tenchatlieu"].Value.ToString();
            btnsua.Enabled = true;
            btnxoa.Enabled = true;
            btnboqua.Enabled = true;
        }
