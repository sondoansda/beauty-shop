...
namespace btl.net.Forms
{
    public partial class Loai : Form
    {
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT Maloai FROM tblloai WHERE Maloai=N'" + txtma.Text.Trim() + "'";
            ...
            sql = "INSERT INTO tblloai(Maloai, Tenloai) VALUES(N'" + txtma.Text.Trim() + "',N'" + txtten.Text.Trim() + "')";
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblloai SET Tenloai=N'" + txtten.Text.ToString() + "' WHERE Maloai=N'" + txtma.Text + "'";
            Class.Functions.RunSql(sql);
            Load_DataGridView();
            ResetValues();
            btnboqua.Enabled = false;
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE FROM tblloai WHERE Maloai=N'" + txtma.Text + "'";
        ...
        private void btntimkiem_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT * FROM tblloai WHERE 1=1";
            if (txtma.Text != "")
                sql += " AND Maloai Like N'%" + txtma.Text + "%'";
            if (txtten.Text != "")
                sql += " AND Tenloai Like N'%" + txtten.Text + "%'";
            tblchatlieu = Class.Functions.GetDataToTable(sql);
            if (tblchatlieu.Rows.Count == 0)
